...
class _AddBlogScreenState extends State<AddBlogScreen> {
  ...
  void _autoGenerateSlug() {
    if (_slugController.text.isEmpty ||
        _slugController.text ==
            BlogModel.generateSlug(
              _titleController.text.substring(
                0,
                _titleController.text.length - 1,
              ),
            )) {
      _slugController.text = BlogModel.generateSlug(_titleController.text);
    }
  }
  ...
  Future<void> _saveBlog() async {
    ...
    final success = await provider.addBlog(
      ...
      coverImageFile: _coverImageBytes,
    ...
    if (success) {
      ...
      Fluttertoast.showToast(
        msg: provider.error ?? 'Failed to create blog post',
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: const InputDecoration(
                              labelText: 'Excerpt *',
                              hintText: 'Short summary (~160 chars for SEO)',
                          ...
                          TextFormField(
                            ...
                            decoration: const InputDecoration(
                              ...
                              hintText: 'Override browser tab / search title',
                            ),
                          ),
                          const SizedBox(height: AppDimensions.paddingM),
                          TextFormField(
                            ...
                            decoration: const InputDecoration(
                              ...
                              hintText: 'Override search result description',
                              alignLabelWithHint: true,
                            ),
                            maxLines: 3,
                          ),
                          ...
                          TextFormField(
                            ...
                            decoration: const InputDecoration(
                              ...
                              hintText: 'refurbished laptops, MacBook, India',
